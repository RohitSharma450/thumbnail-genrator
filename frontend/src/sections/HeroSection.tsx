...
export default function HeroSection() {
    const specialFeatures = [
        ...
        "Fast and Easy to Use - Just Upload an Image",
        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Generate Images in Seconds </span>
            ...
            >
                AI Agent for image generation for{" "}
                <span className="move-gradient px-3 rounded-xl text-nowrap">Designers and Artists</span>
            </motion.h1>
